...
/*
 Один из примеров, на которых можно увидеть, как применяются указатели на
 функции — это использование Linux библиотеки pthread для написания многопоточных приложений. 
